...
CHAPTER_OVERRIDES: Dict[str, List[str]] = {
    ...
    "Start Applying for Jobs": [
        "Online Credibility",
        "SQL Project(s) For Your Portfolio",
        "Job Applications & Resources",
        "Job Assistance Support from Codebasics",
        "The Ultimate Job Application Playbook",
        "Job Hunt Hacks",
        "What's Next?",
    ],
    "Virtual Internship": [
    ...
    "Data Engineering Basics for Data Analysts": [
        "Welcome to Data Engineering for Data Analysts",
        "Enhance Your Learning Experience",
        "Data Engineering Foundation 1",
        "Data Engineering Foundation 2",
        "Project: Build Your First ETL Pipeline Using AWS",
        "Build Your First ETL Pipeline Using AWS (Data Extraction & Storage)",
        "Build Your First ETL Pipeline Using AWS (Data Transformation)",
        "Project: Build Your First ETL Pipeline Using AWS (Data Warehousing & Analytics)",
        "Cloud Tools: An Analyst's Overview",
        "Data Engineering Best Practices",
        "Data Engineering related Interview Questions for Data Analysts",
        "Final Course Completion Test",
        "Next Steps",
    ],
